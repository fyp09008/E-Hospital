...
/**
 * Virtual keyboard panel class for session login.
 * @author   Chun
 */
public class SessionKeyboardPanel extends JPanel {
	/**
	 * 
	 */
	 ...
	 * @uml.associationEnd  
	 */
	SessionLoginPanel relogin;
	
	JButton loginButton;
	
	public SessionKeyboardPanel(SessionLoginPanel lp){
		super();
		relogin = lp;
		initialize();	
	}
